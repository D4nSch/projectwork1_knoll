...
public class Menu : MonoBehaviour 
{
...

	{
		...
		mpLobby = mpLobby.GetComponent<Button> ();
...

	{
		...
		SceneManager.LoadScene("Singleplayer"); //this will load our first level from our build settings. "1" is the second scene in our game
	}
